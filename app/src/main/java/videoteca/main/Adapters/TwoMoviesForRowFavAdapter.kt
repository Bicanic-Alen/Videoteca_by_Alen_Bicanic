...
/**
 * Adapter per visualizzare due film per riga in una RecyclerView dei film.
 *
 * @param items La lista dei dettagli dei film da visualizzare.
 */

@GlideModule
class TwoMoviesForRowFavAdapter(private val items: List<MovieDetails>) : RecyclerView.Adapter<TwoMoviesForRowFavAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
         ...
         */
        fun bind(movie: MovieDetails, layout: ConstraintLayout) {
